...
def readFile(data):
      ...
      def innerReadPDF():
         ...
         if(c==0):
            try:
               file=open("static/Uploads/"+data['data'], "rb")
               lines=list()
      ...
      def innerReadTXT():
         ...
         try:
            ...
            for i in range(c,c+100):
               lines.append(linecache.getline("static/Uploads/"+data['data'], i))
         except Exception as e:
            print(e)
            return
         s=""
...
def deleteFile(filename):
   ...
   return render_template("delete.html",files=os.listdir("static/Uploads"))
...
@app.route('/read')
def read():
   return render_template("read.html",files=os.listdir("static/Uploads"))
